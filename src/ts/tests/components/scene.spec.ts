import { Entity, IEntity } from "../../components/entities/entity.js";
...
describe("scene:", (): void => {
    ...
    it("initialize, no existing scene -> scene has been initialized", (): void => {
        ...
        expect(surfaceController.addEventListener).toHaveBeenCalledWith(SurfaceController.surfaceChangeEvent, (<any>scene)._onRefresh);
    });
    ...
    it("initialize, existing scene -> scene has been initialized", (): void => {
        ...
        //Assert
        expect(surfaceController.removeEventListener).toHaveBeenCalledWith(SurfaceController.surfaceChangeEvent, (<any>scene)._onRefresh);
        expect(surfaceController.addEventListener).toHaveBeenCalledWith(SurfaceController.surfaceChangeEvent, (<any>scene)._onRefresh);
    });
